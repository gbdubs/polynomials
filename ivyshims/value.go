...
package ivyshims // import "robpike.io/ivy/value"
...
var debugConf = &Config{} // For debugging, e.g. to call a String method.
...
type Value interface {
	...
	toType(string, *Config, valueType) Value
}
...
func parseTwo(conf *Config, s string) (Value, Value, string, error) {
	var elems []string
	var sep string
	var typ string
...
func bigFloatInt64(conf *Config, x int64) BigFloat {
